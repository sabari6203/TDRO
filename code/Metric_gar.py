...
def rank(num_user, user_item_inter, mask_items, user_tensor, item_tensor, is_training, step, topk):
    # user_tensor: Shape (num_user, dim_E), item_tensor: Shape (num_item, dim_E)
    start_index = 0
    end_index = num_user if step is None else step
