...
from model_GAR import GAR  # <-- Swap in your GAR model here
...
def init():
    ...
    parser.add_argument('--step', type=int, default=2000, help='Step size.')
    ...
    # GAR-specific or general model args
...
if __name__ == '__main__':
    ...
    step = args.step
    portion_list = eval(args.portion_list) if args.inference and args.portion_list else None
